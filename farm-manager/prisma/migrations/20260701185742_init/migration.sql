...
CREATE TABLE "FarmAccess" (
    ...
    CONSTRAINT "FarmAccess_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "FarmAccess_farmId_fkey" FOREIGN KEY ("farmId") REFERENCES "Farm" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "MonthlyCensus" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "MonthlyCensus_farmId_fkey" FOREIGN KEY ("farmId") REFERENCES "Farm" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "MonthlyCensus_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "BeefSection" (
    ...
    "notes" TEXT,
    CONSTRAINT "BeefSection_censusId_fkey" FOREIGN KEY ("censusId") REFERENCES "MonthlyCensus" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "DairySection" (
    ...
    "femaleCalves" INTEGER NOT NULL DEFAULT 0,
    "totalMilkYield" REAL NOT NULL DEFAULT 0,
    "feedConsumedBags" INTEGER NOT NULL DEFAULT 0,
    "feedWeightKg" REAL NOT NULL DEFAULT 50,
    "notes" TEXT,
    CONSTRAINT "DairySection_censusId_fkey" FOREIGN KEY ("censusId") REFERENCES "MonthlyCensus" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "GoatSection" (
    ...
    "notes" TEXT,
    CONSTRAINT "GoatSection_censusId_fkey" FOREIGN KEY ("censusId") REFERENCES "MonthlyCensus" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "LayerSection" (
    ...
    "averageLayingPct" REAL NOT NULL DEFAULT 0,
    "feedConsumedBags" INTEGER NOT NULL DEFAULT 0,
    "feedWeightKg" REAL NOT NULL DEFAULT 50,
    "notes" TEXT,
    CONSTRAINT "LayerSection_censusId_fkey" FOREIGN KEY ("censusId") REFERENCES "MonthlyCensus" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "BroilerSection" (
    ...
    "feedWeightKg" REAL NOT NULL DEFAULT 50,
    "notes" TEXT,
    CONSTRAINT "BroilerSection_censusId_fkey" FOREIGN KEY ("censusId") REFERENCES "MonthlyCensus" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "CropActivity" (
    ...
    "notes" TEXT,
    CONSTRAINT "CropActivity_censusId_fkey" FOREIGN KEY ("censusId") REFERENCES "MonthlyCensus" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "WorkshopItem" (
    ...
    "notes" TEXT,
    CONSTRAINT "WorkshopItem_censusId_fkey" FOREIGN KEY ("censusId") REFERENCES "MonthlyCensus" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "AuditLog" (
    ...
    "reason" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "AuditLog_farmId_fkey" FOREIGN KEY ("farmId") REFERENCES "Farm" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
